...
def grab_epg():
    ...
    req.add_header(sync_data("VXNlci1BZ2VudA==") , vod_channels("S29kaSBwbHVnaW4gYnkgQmVzdElQVFY="))
...
def load_channels():
    ...
    if statinfo.st_size <> 796:
       plugintools.message(get_live("RVJST1I="),vod_channels("VU5BVVRIT1JJWkVEIEVESVQgT0YgQURET04h"))
       sys.exit()
    statinfo = os.stat(addonDir+"/"+get_live("aW5pdC5weQ=="))
    if statinfo.st_size <> 19111:
       plugintools.message(get_live("RVJST1I="),vod_channels("VU5BVVRIT1JJWkVEIEVESVQgT0YgQURET04h"))
       sys.exit()
